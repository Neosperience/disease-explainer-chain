...
def load_chain(_prompt_template,_vectorstore):
    ...
    llm = ChatOpenAI(temperature=0, openai_api_key=os.environ["OPENAI_API_KEY"], model_name='gpt-4-0125-preview')
...
def main():
    ...
    if user_input:= st.chat_input("Example: What is hypertension?"):
